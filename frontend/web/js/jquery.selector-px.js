;(function($){
    ...
    $('body').append('<style>'+
        ...
        '.sel-box .btn{background:#EF7E2E;overflow:hidden;}'+
        '.sel-box .btn1{width:40px;height:22px;float:left;padding:11px 0px;margin: 0 10px;color: #fff;text-align: center;}'+
        ...
        '.sel-con .border{height:34px;border:solid 1px #EF7E2E;border-width:1px 0;position:fixed;bottom:72px;left:0;right:0;pointer-events:none;}'+
